...
class Uploadhandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => site_url('/uploads/do_upload'),
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/assets/files/advance/',
            'upload_url' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/assets/files/advance/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
